/**
 * <copyright></copyright> $Id: RenderFactoryImpl.java 30791 2008-09-19 20:31:56Z egouge $
 */
...
public class RenderFactoryImpl extends EFactoryImpl implements RenderFactory {
    ...
    /**
     * <!-- begin-user-doc --> Processes the RenderExecutor Extension Point and creates the
     * appropriate Executor <!-- end-user-doc -->
     * 
     * @generated NOT
     */
    ...
    /**
     * searches through the RenderExecutor Extension point and locates the RenderExecutor whose
     * associated renderer is closest in hierarchical terms to the renderer parameter.
     * 
    ...
    /**
     * searches through the RenderExecutor Extension point and locates the RenderExecutor whose
     * associated renderer and exact match to the renderer class passed in as a parameter
     * 
     ...
     * 
     * @param selection Indicates whether the getQuery method will return a query for selected
     *        features.
     * @return a new RenderContext object for a renderer that renders selections.
     */
     ...
     * <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated public InfoList createInfoListFromString(EDataType eDataType, String initialValue) {
     *            return (InfoList)super.createFromString(eDataType, initialValue); }
     */
     ...
     * @generated
     */
    public String convertInfoListToString( EDataType eDataType, Object instanceValue ) {
        return super.convertToString(eDataType, instanceValue);
    }
    ...
    public Envelope createEnvelopeFromString( EDataType eDataType, String initialValue ) {
        ...
        return new ReferencedEnvelope(new Envelope(Double.parseDouble(coords[0]), Double
                .parseDouble(coords[1]), Double.parseDouble(coords[2]), Double
                .parseDouble(coords[3])), null);
    }
    ...
    public String convertEnvelopeToString( EDataType eDataType, Object instanceValue ) {
        ...
        return env.getMinX() + "," + env.getMaxX() + "," + env.getMinY() + "," + env.getMaxY(); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    }

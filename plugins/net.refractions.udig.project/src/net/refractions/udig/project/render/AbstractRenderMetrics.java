 ...
 * <p>
 * RenderMetrics objects are used to decide which renderer to instantiate to
 ...
 * <li>appearance metric - how well the renderer can style the georesouce given the layer information</li>
 * </ul>
 * 
...
public abstract class AbstractRenderMetrics {
    ...
    /**
     * A list of style ids the renderer expects to use during rendering.
     * This is used to compute the appearanceMetric
     */
    private final List<String> expectedStyleIDs;
    
    /**
     * The Latency Metric - the expected time it takes to connect to a georesource.
     * Generally, local georesources should have a lower latency than network georesources.
     * <p>Measured in milliseconds.</p>
     */
    protected long latencyMetric = LATENCY_LOCAL;
    /**
     * The Time to Draw Metric - the expect time is takes to complete drawing.  The time
     * from when it starts to draw to when it is complete.  Generally, images already in raster
     * format will draw faster then vector based features that have to be converted to raster
     * format before drawing.
     * <p>Measured in milliseconds.</p>
     */
    ...
    /**
     * The datastore is cached in memory once initial read. Can initial be read from disk
     * or network.
     */
    public static final long LATENCY_MEMORY_CACHE = 100;
    
    /**
     * The datastore is located on local disk. Is is read each time
     * it is rendered.
     * 
     * Example: Shapefile
     */
    ...
    /**
     * The data is cached locally but may first have to been read from
     * a non-local server.  This data is stored on locally on a disk.
     * 
     ...
     * 
     * <p>
     * This id will be assigned by the RendererExtensionProcessor when
     * the render metrics are processed.
     * 
     * <p>
     * It is currently used by the render metrics to override the
     * renderer choice by storing this id on the blackboard to force
     * the renderer to be chosen.
     * 
     * 
     */
    private String id;
     ...
     */
    protected AbstractRenderMetrics( final IRenderContext context, final IRenderMetricsFactory factory, List<String> expectedStyleIds ) {
     ...
     * 
     * No restriction on scale by default - override to provide
     * one or more valid scale ranges for this renderer.
     * </p>
     * 
    ...
    /**
     * Returns a number that represents the expected latency of connecting to the 
     * georesource.   Measured in milliseconds.
     * <p>
     * This will be used by the RenderCreator to determine which renderer to use for a given
     * georesource.  
     * </p>
     * 
     * For defaults: use one of LATENCY_MEMROY, LATENCY_MEMORY_CACHE, LATENCY_LOCAL, LATENCY_LOCAL_CACHE, LATENCY_NETWORK, LATENCY_NETWORK_CACHE
     *
    ...
    /**
     * Returns a number the represents the expected time to draw of the georesouce.
     * The time to draw is the difference between the time when drawing started and
     * the time when drawing completed.  It should not include the latency between when the request
     * is made and drawing can start.  Measured in milliseconds.
     * 
     * <p>This will be used by the RenderCreator to determine which renderer to use for a given
     * georesouce.
     * </p>
     * @return
     */
     ...
     * <p>
     * This number is used to represents how must distortion will be shown to the
     * user when this renderer is used to drawn on the screen.
     * <p>
     * This will be used by the RenderCreator to determine which renderer to use for a given georesouce.
     * </p>
     *
     * @return
     */
     ...
     * 
     * <p>
     * Based on the number of styles
     * on the blackboard that the renderer can use divided by
     * the number styles the renderer users.
     * </p>
     * 
     * <p>
     * Makes use of canStyle(String, Object) to ensure the renderer can use the style
     * on the blackboard.
     * </p>
     * 
     * 
    ...
    /**
     * Computes a "user" appearance metric identifying how well a renderer can style the
     * resource given the styles on the blackboard.
     * 
     * <p>
     * Based on the number of styles
     * on the blackboard that the renderer can use divided by
     * the number of styles on the blackboard (provided by the user).
     * </p>
     * 
     * <p>
     * Makes use of canStyle(String, Object) to ensure the renderer can use the style
     ...
     * <p>
     * The list of expected style IDs is used to determine how
     * wel the current style blackboard meets your needs:
     * <ul>
     * <li>Are all the styles you need available? Use getRenderAppearanceMetric() to learn more.
     * <li>Are all the styles provided the user going to be respected? Use getUserAppearanceMetric() to learn more.
     * </ul>
     * Developers please note that you must pass in the list of expected
     * style in to the constructor.
     * 

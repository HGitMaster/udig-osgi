...
public class GMLServiceExtension extends AbstractDataStoreServiceExtension implements ServiceExtension {
    ...
    /**
     * Factory used to describe connection parameters.
     *
     * @return factory used to describe connection parameters.
     */
    public static GMLDataStoreFactory getFactory(){
    ...
    public static Param getURLP() {
        if(URLP == null) {
            URLP = getFactory().getParametersInfo()[0];
        }
        return URLP;
    }

...
/**
 * The concrete implementation of the wizard 'Page' used to import data using 
 * a database in the ArcSDE format from ESRI. 
 * 
...
public class ArcSDEWizardPage extends AbstractProprietaryDatastoreWizardPage {
    ...
    //CONNECTION 
    private static final DataBaseConnInfo DEFAULT_ARCSDE_CONN_INFO = 
        new DataBaseConnInfo("","","","","","");    //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$

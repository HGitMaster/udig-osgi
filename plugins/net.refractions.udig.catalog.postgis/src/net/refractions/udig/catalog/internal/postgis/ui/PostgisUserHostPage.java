 ...
 * @since 1.1.0
 */
public class PostgisUserHostPage extends AbstractUDIGImportPage implements UDIGConnectionPage {
        ...
        previousConnections.addListener(SWT.Selection, new Listener(){
            ...
            public void handleEvent( Event event ) {
                ...
                if (settings != null) {
                    ...
                    PostgisUserHostPage.this.password.setFocus();
                }
    ...
    private Text createLabelAndText( Composite parent, String labelText, int textStyle ) {
        ...
        ImageRegistry imageRegistry = PostgisPlugin.getDefault().getImageRegistry();
    ...
    private boolean canConnect() throws InterruptedException {
        ...
        try {
            ...
            PostgisPlugin.log("Error while running database connection runnable", e);
            return false;
        }
    }
    /**
